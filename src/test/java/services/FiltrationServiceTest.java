...
public class FiltrationServiceTest {
	...
	String[] relevantMessages = new String[] {"switch from gson to jackson", "transition between jackson and gson", "move to jackson from gson"};
	String[] irrelevantMessages = new String[] {"comparison of gson and jackson", "performance testing for gson and jackson", "added jackson to support gson"};
